...
public abstract class AbstractMenuButton extends XButton {
	...
	public AbstractMenuButton(Dimension dimension, String text, XFrame frame, ButtonType type, String appearanceName) {
		super(dimension, text, frame, type, appearanceName);
	}

	public AbstractMenuButton(Dimension dimension, XFrame frame, ButtonType type, String appearanceName) {
		super(dimension, frame, type, appearanceName);
	}

	public AbstractMenuButton(int x, int y, int width, int height, String text, XFrame frame, ButtonType type, String appearanceName) {
		super(x, y, width, height, text, frame, type, appearanceName);
	}

	public AbstractMenuButton(int x, int y, int width, int height, XFrame frame, ButtonType type, String appearanceName) {
