 ...
 * responsible for handling the competition menu button's key actions.
 */
public final class CompetitionMenuKeyActions {
     ...
     * related to the competition menu button's key actions.
     *
     ...
     * empty competition button inside the competition menu button's dropdown panel.
     */
    private final class EmptyCompetitionKeyAction extends AbstractAction {
        @Override
     ...
     * competition from database button inside the competition menu button's dropdown panel.
     */
    private final class CompetitionFromDatabaseKeyAction extends AbstractAction {
        @Override
        public void actionPerformed(ActionEvent e) {
     ...
     * competition stats button inside the competition menu button's dropdown panel.
     */
    private final class CompetitionStatsKeyAction extends AbstractAction {
        @Override
        public void actionPerformed(ActionEvent e) {
