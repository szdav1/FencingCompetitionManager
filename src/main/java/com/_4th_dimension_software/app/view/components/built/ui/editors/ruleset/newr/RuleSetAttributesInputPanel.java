...
/**
 * The <code>RuleSetAttributesInputPanel</code> class is a subclass
 * of the <code>AbstractEditorInputPanel</code> and an inner
 * panel for the <code>NewRuleSetEditor</code> class, that holds the
 * necessary UI elements for rule set attributes.
 */
public final class RuleSetAttributesInputPanel extends AbstractEditorInputPanel {
	/**
	 * Constructs a <code>RuleSetAttributesInputPanel</code> object. This
	 ...
	 */
	public RuleSetAttributesInputPanel(String title, final XFrame frame, String appearanceName) {
