...
/**
 * The <code>TableRuleSetInputPanel</code> class is a subclass
 * of the <code>AbstractEditorInputPanel</code> and an inner
 * panel for the <code>NewRuleSetEditor</code> class, that holds the
 * necessary UI elements for table rules.
 */
public final class TableRuleSetInputPanel extends AbstractEditorInputPanel {
	/**
	 * Constructs a <code>TableRuleSetInputPanel</code> object. This
	 ...
	 */
	public TableRuleSetInputPanel(String title, final XFrame frame, String appearanceName) {
