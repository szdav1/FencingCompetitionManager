...
/**
 * The <code>AbstractXLabel</code> abstract class defines the abstract
 * behaviour of labels inside the application. It is a subclass of
 * swing's default <code>JLabel</code> class. It implements the basic
...
public abstract class AbstractXLabel extends JLabel implements XComponent, CustomGraphicsUser {
	...
	/**
	 * Defines the constructor of the labels that
