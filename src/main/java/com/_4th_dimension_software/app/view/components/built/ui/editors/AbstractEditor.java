...
public abstract class AbstractEditor extends XPanel {
	...
	/**
	 * Defines the base constructor of editors. The base
	 * constructor initializes all UI elements of an editor,
	 * and creates an anonymous instance of the <code>AbstractEditorController</code>
	 * controller class. This controller handles the closing of editors.
	 *
